...
def create_polygons():
    ...
    df = pd.read_csv('../json_files/cm.csv')
...
def compute_location_area(location: str):
    """
    ...
    # Get location from Google Geocoding
    location = get_location(location)

    # Assign area location based on polygon fit
    candidate_area = check_map_location(location, polygons)
